...
declare namespace qg {
  ...
  export function createInterstitialAd(object: any): _InsertAd;

  /**
  * 创建桌面图标，每次创建都需要用户授权
  * 支持最低平台版本号'1040' (minPlatformVersion>='1040')
  */
  export function installShortcut(object: _vibrateLongObject): void;

  export function hasShortcutInstalled(obj: any): void;

  /**
   * 打开另一个小游戏
   * 支持最低平台版本号'1044' (minPlatformVersion>='1044')
   * @param object 
   */
  export function navigateToMiniGame(object: _navigateToMiniGame): void
